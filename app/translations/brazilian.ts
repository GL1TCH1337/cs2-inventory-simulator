...
export const brazilian = {
  ...
  CraftImportError502: "Falha ao buscar os dados do link de inspeção, tente novamente.",
  CraftImportErrorUnknown: "Ocorreu um erro inesperado.",
  CraftImportFailedTitle: "Falha na importação",
  ...
  EditorConfirmPick: /* csgo_brazilian.txt */"Selecionar",
  ...
  EditorPick: /* csgo_brazilian.txt */"Escolher",
  EditorPreview: /* csgo_brazilian.txt */"Pré-visualização",
  ...
  EditorStickerEdit: /* csgo_brazilian.txt */"Editar",
  EditorStickerRotation: /* csgo_brazilian.txt */"Rotação",
  EditorStickerWear: "Desgaste",
  EditorStickerX: /* csgo_brazilian.txt */"Desloc. X",
  EditorStickerY: /* csgo_brazilian.txt */"Desloc. Y",
  EditorStickers: /* csgo_brazilian.txt */"Adesivos",
  EditorWear: /* csgo_brazilian.txt */"Desgaste",
  ErrorAlertFailedToAuth: "Houve um problema ao iniciar o processo de login com a Steam. Por favor, tente novamente.",
  ErrorAlertFailedToAuthTitle: "Não foi possível conectar à Steam",
  ErrorAlertFailedToValidate: "Não foi possível verificar seu login com a Steam. Por favor, tente fazer o login novamente.",
  ...
  KeychainPickerHeader: "Escolha um chaveiro...",
  KeychainPickerRemove: "Remover",
  KeychainPickerSearchPlaceholder: "Procurar chaveiro...",
